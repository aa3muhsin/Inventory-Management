    ...
    public class AssetConfiguration : IEntityTypeConfiguration<Asset>
    {
        public void Configure(EntityTypeBuilder<Asset> builder)
        {
            ...
            builder.HasData(
                ...
                new Asset { Id = 6, AssetNumber = "C8619C2", Status = AssetStatus.Assigned, PurchasedDate = DateTime.Parse("2021-01-15 14:00"), LastReturnedDate = DateTime.Parse("2021-01-15 14:00"), TypeId = 1 },
                new Asset { Id = 7, AssetNumber = "C8619C3", Status = AssetStatus.Assigned, PurchasedDate = DateTime.Parse("2021-01-15 14:00"), LastReturnedDate = DateTime.Parse("2021-01-15 14:00"), TypeId = 2 },
                new Asset { Id = 8, AssetNumber = "C8619C4", Status = AssetStatus.Assigned, PurchasedDate = DateTime.Parse("2021-01-15 14:00"), LastReturnedDate = DateTime.Parse("2021-01-15 14:00"), TypeId = 3 },
                new Asset { Id = 9, AssetNumber = "C8619C5", Status = AssetStatus.Assigned, PurchasedDate = DateTime.Parse("2021-01-15 14:00"), LastReturnedDate = DateTime.Parse("2021-01-15 14:00"), TypeId = 4 },
